...
-define(MAGIC, 16#0abcdef).   % wdets cookie, won't ever change.
%% Status values.
...
-define(WDETS_CALL(Pid, Req), {'$wdets_call', Pid, Req}).
...
-record(head,  {
	  ...
	  parent,               % The supervisor of Wdets processes.
	  server,               % The creator of Wdets processes.
